...
So, with our fit classification model for the Training dataset, let us evaluate the Test.
...
m1_t <- train(classe ~ . , data = dTrain, method = "rpart", na.action= na.omit)

m2rF_t <- train(classe ~ . , data = dTrain, method = "rf", na.action= na.omit)
